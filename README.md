...
arger::Option(std::string name, arger::IsId auto id, const arger::IsConfig<detail::Option> auto&... configs);
...
arger::Group(std::string name, const arger::IsConfig<detail::Group> auto&... configs);
arger::Group(std::string name, arger::IsId auto id, const arger::IsConfig<detail::Group> auto&... configs);
...
arger::HelpEntry(std::string name, bool reducible, const arger::IsConfig<detail::SpecialEntry> auto&... configs);
...
arger::Information(std::string name, std::string text, const arger::IsConfig<detail::Information> auto&... configs);
arger::Information(std::string name, std::string reduced, std::string text, const arger::IsConfig<detail::Information> auto&... configs);
...
arger::Positional(std::string name, arger::Type type, std::string desc);
arger::Positional(std::string name, arger::Type type, const arger::IsConfig<detail::Positional> auto&... configs);
...
arger::Config config{ true,
	arger::Program{ "test.exe" },
	arger::VersionText{ "Version [1.0.1]" },
	arger::Information{ "Some Description", "This is the indepth description." },
	arger::Description{ "Some test program" },
	arger::Option{ "test", Option::test,
		arger::Abbreviation{ 't' },
		arger::Description{ "This is the description of the test flag." }
	},
	arger::HelpEntry{ "help",
		arger::Abbreviation{ 'h' },
		arger::Description{ "Print this help menu." }
	},
	arger::VersionEntry{ "version",
		arger::Abbreviation{ 'v' },
		arger::Description{ "Print the program version." }
	},
	arger::Option{ "path", Option::path,
		arger::Abbreviation{ 'p' },
		arger::Payload{ "file-path", arger::Primitive::any },
		arger::Description{ "This is some path option" },
		arger::Require{ 1, 0 }
	},
	arger::Option{ "mode", Option::mode,
		arger::Payload{ "test-mode",
			arger::Enum{
				arger::EnumEntry{ "abc", Mode::abc, "This is the description of option abc" },
				arger::EnumEntry{ "def", Mode::def, "This is the description of option def" }
			},
		},
		arger::Default{ "def" },
		arger::Description{ "Example of an enum" }
	},
	arger::Require{ 2, 0 },
	arger::Positional{ "first", arger::Primitive::unum, "First Argument" },
	arger::Positional{ "second", arger::Primitive::boolean, "Second Argument" },
	arger::Positional{ "third", arger::Primitive::any, "Third Argument" },
	arger::Constraint{ [](const arger::Parsed& p) {
		if (p.positional(0)->unum() >= 50)
			return "Argument must be less than 50";
		return "";
	}}
};
...
arger::Config config{ true,
	...
	arger::Option{ "mode", Option::mode,
		arger::Payload{ "test-mode",
			arger::Enum{
				arger::EnumEntry{ "abc", Mode::abc, "Short text abc", "This is the description of option abc" },
				arger::EnumEntry{ "def", Mode::def, "Short text def", "This is the description of option def" }
			},
		},
		arger::Description{ "Example of an enum" },
		arger::Default{ "def" }
	},
	arger::Group{ "get", Group::get,
		arger::Description{ "Get something in the test program. But this is just a demo description" },
		arger::Require{ 2, 4 },
		arger::Positional{ "first", arger::Primitive::unum, "First Argument" },
		arger::Positional{ "second", arger::Primitive::boolean, "Second Argument" },
		arger::Positional{ "third", arger::Primitive::any, "Third Argument" },
	...
	arger::Group{ "set", Group::set,
		arger::Description{ "Set something in the test program. But this is just a demo description" },
		arger::Require{ 1 },
		arger::Positional{ "first", arger::Primitive::unum, "First Argument" },
		arger::PartOf{ refPath }
	},
	arger::Group{ "read", Group::read,
		arger::Require{ 2 },
		arger::Positional{ "argument", arger::Enum{
			arger::EnumEntry{ "a", 0, "This is [a] description" },
			arger::EnumEntry{ "b", 1, "This is [b] description" }
		}, "First Argument" },
		arger::Information{ "Read-Help", "This is the short text", "This is a help-description only shown for read."}
	}
};
